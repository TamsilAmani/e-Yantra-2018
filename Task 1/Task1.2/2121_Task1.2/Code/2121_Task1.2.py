...
############################ Processing the given 5 input Images ###################
...
def aruco_detect(path_to_image):
    ...
    det_aruco_list = al.detect_Aruco(img2, img_name)
    if det_aruco_list:
        ...
        img3 = al.mark_Aruco(img2, det_aruco_list)
        id_aruco_trace = al.calculate_Robot_State(img3, det_aruco_list)
...
if __name__ == "__main__":
    ...
    while choice != '0':
        img_name = str(input("\nEnter file name ( as 'file_name.jpg'): "))
        ...
        if not os.path.isfile(path):
            ...
            if flag:
                color1 = str(input("\nEnter Object 1 color [red, green, blue, none]: "))
                shape1 = str(input("\nEnter Object 1 shape [triangle, square, circle, none]: "))

                color2 = str(input("\nEnter Object 2 color [red, green, blue, none]: "))
                shape2 = str(input("\nEnter Object 2 shape [triangle, square, circle, none]: "))
                ...
                elif ((not color1 == "red" and not color1 == "green" and not color1 == "blue" and not color1 == "none") or (
                        not color2 == "red" and not color2 == "green" and not color2 == "blue" and not color2 == "none")) or (
                        (not shape1 == "triangle" and not shape1 == "square" and not shape1 == "circle" and not shape1 == "none") or (
                        not shape2 == "triangle" and not shape2 == "square" and not shape2 == "circle" and not shape2 == "none")):
