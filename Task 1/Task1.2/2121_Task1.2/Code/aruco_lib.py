...
def detect_Aruco(img,img_name):  #returns the detected aruco list dictionary with id: corners
    aruco_list = {}
    gray = cv2.cvtColor(img, cv2.COLOR_BGR2GRAY)

    if(img_name=="Image1.jpg" or img_name=="Image2.jpg"):
    ...
    elif(img_name=="Image3.jpg" or img_name=="Image4.jpg"):
